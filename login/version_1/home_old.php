...
<?php
	...
	if (isset($_GET["user"])){
        ...
        if ($login_exist==0) {
			...
			$result = mysql_query("SELECT name, surname FROM Users WHERE user='$login'",$conexion);
			...
			<div id="content">
				<div id="sub-menu">
					<?php echo 'Bienvenido/a, <b>'.$login.'</b>.';?>
				</div>
				<div id="front-page">
					<p><h1>PORTAL DEL TRABAJADOR</h1><br>
					A trav&eacute;s de esta plataforma podr&aacute; tanto formalizar la petici&oacute;n de d&iacute;as libres como tambi&eacute;n podr&aacute; notificar cualquier ruego, pregunta o sugerencia que desee resolver.<br>
