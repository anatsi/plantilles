        ...
        if ($login_exist==0) {
			...
			<div id="top-bar" align="center">
				...
				<div id="front-page">
					...
					<p></br>
						<p style="text-align: center;"><b><font size='2oem' color='black'>D&iacute;as a aceptar: </b><BR>
							<?php
							...
							//MOSTRAR FECHAS ELEGIDAS PENDIENTES PARA APROBAR
								...
								echo "<form name='formulario2' method='POST' >
									<p style='text-align: center;'>
									<b>Computar d&iacute;as al a&ntilde;o</b></br>
									<select name='year_apply'>
										<option value='2014'>2014</option>
										<option value='2015'>2015</option>
										<option value='2016' selected='selected'>2016</option>
									</select></br></br></br>";
									?>
									<input type="submit"  style="padding:5px; color: #FFFFFF; border: #000 1px solid; background-color: red" onclick = "this.form.action = './admin_resumen.php'" value="VOLVER ATRAS" />
									<input type="submit"  style="padding:5px; color: #FFFFFF; border: #000 1px solid; background-color: green" onclick = "this.form.action = './sent.php'" value="ACEPTAR PETICI&Oacute;N" /></p>
									<?php
